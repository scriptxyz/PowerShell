...
#                                script path.                      #
#                    21.07.2018: Replaced line "Get-ChildItem      #
#                                "C:\`$Recycle.bin\" -Recurse      #     
#                                -Force | Remove-Item -Recurse     #
#                                -Force -ErrorAction               #
#                                SilentlyContinue" with            #
#                                "Get-ChildItem                    #
#                                "C:\`$Recycle.Bin\" -Force | del  #
#                                -Recurse -ErrorAction             #
#                                SilentlyContinue".                #
#                                Newer versions of Windows 10 were #
#                                flagging an error using the old   #
#                                command. As new users log on to a #
#                                machine the contents of their     #
#                                recycle bin are stored here,      #
#                                depicted by their account SID.    #
#                                The new command performs the same #
#                                task.                             #
####################################################################
#>
...
Write-Host Deleting script. -ForegroundColor Green
del $ScriptPath\AppLayeringImagePrep.ps1
